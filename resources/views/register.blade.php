                                ...
                                <form action="{{route('register')}}" method="post">
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="form-floating mb-3">
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="email" placeholder="Your full name" >
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="password" class="form-control" name="password_confirmed" id="confirm_password" value="" placeholder="Confirm Password" >
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-center">
                                            <a href="{{route('login.page')}}" class="link-secondary text-decoration-none">Click here to login</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
